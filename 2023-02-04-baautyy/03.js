...
function bienvenidoSr(persona) {
  ...
  //
  // Tu código:
  if ('nombre' in persona && 'apellido' in persona && 'invitado' in persona && persona["invitado"] == true) {
   return (persona["nombre"] + " " + persona["apellido"] + ", un gusto tenerlo nuevamente! Bienvenido") 
  }
  else if ('apellido' in persona && 'invitado' in persona && persona["invitado"] == true) {
    return ("Bienvenido Sr. " + persona["apellido"]);
  }
  else if ('nombre' in persona && 'invitado' in persona && persona["invitado"] == true) {
